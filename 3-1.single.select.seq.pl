...
unless(-e $blast){system("cat $main/split_species/$genome.Chrs/*.m8 >$main/$blast");}
...
open(PURC, ">$main/selected.complete.seq.fasta") or die "$!";
open(PUR, ">$main/selected.purpose.seq.fasta") or die "$!";
